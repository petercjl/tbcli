...
{ key: 'profit estimate list', maturity: 'stable', audience: 'business', capability: {id:'profit-estimate-list',name:'查找已有利润快照',description:'只读查找覆盖指定店铺和日期的已有利润结果，返回覆盖日期与计算口径。',examplePrompt:'查看有哪些覆盖7月和8月的利润结果',requiredInputs:['已配置的只读数据库访问'],optionalInputs:['店铺键','起止日期','返回数量'],delivery:'已有快照及实际覆盖信息',commandTemplate:'tbcli profit estimate list [--shop-key <KEY>] [--start-date <日期> --end-date <日期>] [--limit <数量>] --json'} },
  { key: 'profit estimate query', maturity: 'stable', audience: 'business', capability: {id:'profit-estimate-query',name:'读取已有预估利润',description:'只读汇总已有利润结果，支持按负责人和月份对比。',examplePrompt:'对比各负责人7月与8月的预估利润',requiredInputs:['快照编号'],optionalInputs:['负责人','日期范围','汇总粒度'],delivery:'利润拆分和实际数据日期',commandTemplate:'tbcli profit estimate query --run-id <ID> [--group-by shop|owner|product|day|month|owner-month] [--start-date <日期> --end-date <日期>] --json'} },
